  ...
  <main>
    <section class="content">
      ...
      <h5>Détails du livre n°${livre.getId()}</h5>
        <div class="row">
	      <form action="/TP3Ensta/livre_details?id=${livre.getId()}" method="post" class="col s12">
	        <div class="row">
	    ...
	    <c:if test="${empruntsEnCours != null}">
	        <div class="row">
	          <div class="col s12">
		        <table class="striped">
	              <thead>
	              ...
	              <tbody id="results">
	                ...
	                <c:forEach var="emprunt" items="${empruntsEnCours}">
	                    <tr>
	                        <td>${emprunt.getMembre().getNom()} ${emprunt.getMembre().getPrenom()}</td>
